...
function Spotify(){
    ...
    return (
        <>
            <Header/>
            <main className='main'>
                <h1 className='main__title'>Choose a Spotify Plan</h1>
                <p className='main__description'>Select the subscription type for a period of 12 months:</p>
